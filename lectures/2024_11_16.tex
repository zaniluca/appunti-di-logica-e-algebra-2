...
\begin{equation*}
    \MCD\{ p_i(x), p_j(x)\} = 1 \qquad \forall 0 \leq i \leq k, 1 \leq j \leq k, i \neq j
\end{equation*}
\begin{align*}
    \implies \nicefrac{\mathbb{F}_p[x]}{\langle f\rangle} \overset{\substack{\text{isomorfismo di} \\\text{anelli}}}{\simeq} \nicefrac{\mathbb{F}_p[x]}{\langle p_1(x)\rangle} \times \ldots \times \nicefrac{\mathbb{F}_p[x]}{\langle p_k(x)\rangle}
\end{align*}
...
\begin{definition}[Prodotto righe per colonne di matrici 2 x 2]
    Sia
    \begin{equation*}
        \Mat_{2 \times 2}(K) = \left\{\begin{pmatrix} x_1 & x_2 \\ x_3 & x_4 \end{pmatrix} : x_i \in K \right\}
    \end{equation*}
...
\begin{definition}[Algorimo di Strassen per il prodotto di matrici 2 x 2]
    ...
    Definiamo
    \begin{align*}
        \Roman 1 & := (x_1 + x_4)(y_1 + y_4)  \\
        \Roman 2 & := (x_3 + x_4)y_1          \\
        \Roman 3 & := x_1(y_2 + y_4)          \\
        \Roman 4 & := x_4(-y_1 + y_3)         \\
        \Roman 5 & := (x_1 + x_2)y_4          \\
        \Roman 6 & := (-x_1 + x_3)(y_1 + y_2) \\
        \Roman 7 & := (x_2 - x_4)(y_3 + y_4)
    \end{align*}
    Allora
    \begin{align*}
        z_1 & = \Roman 1 + \Roman 4 - \Roman 5 + \Roman 7 \\
        z_2 & = \Roman 3 + \Roman 5                       \\
        z_3 & = \Roman 2 + \Roman 4                       \\
        z_4 & = \Roman 1 + \Roman 3 - \Roman 2 + \Roman 6
    \end{align*}
\end{definition}
...
\begin{example}
    ...
    Quindi
    \begin{equation*}
        AB = \begin{pmatrix} \Roman 1 + \Roman 4 - \Roman 5 + \Roman 7 & \Roman 3 + \Roman 5 \\ \Roman 2 + \Roman 5 & \Roman 1 + \Roman 3 - \Roman 2 + \Roman 6 \end{pmatrix} =
...
\begin{equation*}
    MN = \begin{pmatrix}
        \Roman 1 + \Roman 4 - \Roman 5 + \Roman 7 & \Roman 2 + \Roman 5                       \\
        \Roman 3 + \Roman 4                       & \Roman 1 + \Roman 3 - \Roman 2 + \Roman 6
    \end{pmatrix}
\end{equation*}
Secondo passo: calcoliamo il prodotto in $\Roman 1, \Roman 2, \Roman 3, \ldots , \Roman 7$ con l'algoritmo di Strassen.

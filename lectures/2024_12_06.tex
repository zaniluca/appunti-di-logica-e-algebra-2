...
\begin{definition}[Logica T]
    La logica K a cui aggiungiamo l'assioma $\Box F \implies F$ si chiama \textbf{logica T}.
\end{definition}
Dato lo schema di formule $\Box F \implies F$, i teoremi della logica T sono validi su frame riflessivi.
\begin{definition}[Logica S4]
    ...
    Avremmo così definito la \textbf{logica S4}.
\end{definition}
...
\begin{definition}[Logica S5]
    ...
    Avremmo così definito la \textbf{logica S5}.
\end{definition}
...
\begin{enumerate}[label=\arabic*)]
    \item $\vdash_{S5} \neg \Box \neg F \implies \Box \neg \Box \neg F$
    \item $\vdash_{S5} \Diamond F \implies \Box \Diamond F$ (1 + $\text{def}_\Diamond$)
    \item $\vdash_{S5} \Box \neg F \implies \neg F$ (assioma T)
    \item $\vdash_{S5} \neg \neg F \implies \neg \Box \neg F$ (3 + tautologia)
    \item $\vdash_{S5} F \implies \Diamond F$ (4 + $\text{def}_\Diamond$ + tautologia)
...
\begin{enumerate}
    ...
    \item $\vdash \neg \Box \neg \neg \Box \neg F \implies \neg \Box \neg F$ (4 + tautologia)
    \item $\vdash \Diamond \Diamond F \implies \Diamond F$ ($\text{def}_\Diamond$)
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item $\vdash_K B_j, \vdash_K B_h$ dove $B_h \equiv B_i \implies B_i$. Allora per induzione $\vDash B_j, \vDash B_j \implies B_i$ e quindi $\vDash B_i$
    \end{enumerate}
\end{proof}
